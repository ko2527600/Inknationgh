...
export default function Legal() {
  const metadata = pageMetadata.legal
  const { cmsData } = useCMSStore()
  const legalData = cmsData.legal
        ...
        <main className="min-h-screen bg-white">
          ...
          <section className="bg-linear-to-br from-black to-gray-900 text-white py-16 md:py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <h1 className="text-5xl md:text-6xl font-black mb-6">{legalData.title}</h1>
          ...
          <section className="py-16 md:py-24">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="prose prose-lg max-w-none">
                ...
                {legalData.content && !legalData.sections?.length && (
                  <ReactMarkdown>{typeof legalData.content === 'string' ? legalData.content : ''}</ReactMarkdown>
                )}
